                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6 text-center">
                                                    <a href="{{url('/updateDoctorPage/'.$doctor->id)}}"><button class="btn-primary btn">Update</button></a>
                                                </div>
                                                <div class="col-sm-6 text-center">
                                                    <a href="{{url('/deleteDoctor/'.$doctor->id)}}"><button class="btn-primary btn">Delete</button></a>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
