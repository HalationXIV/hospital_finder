                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="row form-group">
                                                    <div class="col-sm-6">
                                                        <a href="{{url('/mapHospitalDoctorAvailable/'.$hospital->id)}}" class="btn-primary btn">Map Hospital with Doctor</a>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <a href="{{url('/updateHospitalPage/'.$hospital->id)}}" class="btn-primary btn">Update Hospital</a>
                                                    </div>
                                                </div>

                                                <div class="row form-group">
                                                    <div class="col-sm-6">
                                                        <a href="{{url('/mapHospitalInsuranceAvailable/'.$hospital->id)}}" class="btn-primary btn">Map Hospital with Insurance</a>
                                                    </div>

                                                    <div class="col-sm-6">
                                                        <a href="{{url('/deleteHospital/'.$hospital->id)}}" class="btn-primary btn">Delete Hospital</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
