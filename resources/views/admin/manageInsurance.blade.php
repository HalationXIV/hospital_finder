                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6 text-center">
                                                    <a href="{{url('/updateInsurancePage/'.$insurance->id)}}"><button class="btn-primary btn">Update</button></a>
                                                </div>
                                                <div class="col-sm-6 text-center">
                                                    <a href="{{url('/deleteInsurace/'.$insurance->id)}}"><button class="btn-primary btn">Delete</button></a>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
