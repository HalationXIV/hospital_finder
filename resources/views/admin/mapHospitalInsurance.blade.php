            ...
            <form class="form-horizontal" role="form" method="POST" action="{{url('/addHospitalInsuranceAvailableMapping/'.$hospital->id)}}" enctype="multipart/form-data">
                ...
                <div class="panel panel-default container-fluid">
                    ...
                    <div class="panel-body row">
                            ...
                            <table class="table">
                                ...
                                @foreach($hospital_insuraces as $hospital_insurace)
                                    <tr>
                                        ...
                                        {{--<td><a href="{{url('/addHospitalDoctorMapping/'.$hospital->id.'/'.$doctor->id)}}" class="btn-primary btn">Map Doctor</a></td>--}}
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
                        ...
                        <div class="row">
                            <div class="col-sm-2">
                                <button type="submit" class="btn-primary btn">Map Insurances</button>
                            </div>
                            <div class="col-sm-10">
                                <a href="{{url('/editMappedInsurances/'.$hospital->id)}}" class="btn-primary btn">Edit Mapped Insurances</a>
                            </div>
                            {{--<div class="col-sm-10">--}}
                                {{--<a href="{{url('/editMappedDoctors/'.$insurance->id)}}" class="btn-primary btn">Edit Mapped Doctors</a>--}}
                            {{--</div>--}}
                        </div>
                    </div>
                    @else
