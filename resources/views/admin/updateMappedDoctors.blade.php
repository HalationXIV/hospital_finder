        ...
        <div class="row">
                ...
                <div class="panel panel-default container-fluid">
                    ...
                    <div class="panel-body row">
                            ...
                            <table class="table">
                                ...
                                @foreach($doctors as $doctor)
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{url('/deleteHospitalDoctorMapping/'.$doctor->transaction_id)}}" class="btn-primary btn">Delete Doctor Mapping</a></td>
                                        <td><button class="btn-primary btn" type="submit">Update Mapped Doctor</button></td>
                                    </tr>
                                    </form>
                                @endforeach
                                </tbody>
                        ...
                        <div class="row">
                            <div class="col-sm-2">
                                <a href="{{url('/mapHospitalDoctorAvailable/'.$hospital->id)}}" class="btn-primary btn">Map Available Doctor</a>
                            </div>
                        </div>
                    </div>
                </div>
