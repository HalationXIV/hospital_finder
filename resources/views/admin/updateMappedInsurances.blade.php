        ...
        <div class="row">
            ...
            <div class="panel panel-default container-fluid">
                ...
                <div class="panel-body row">
                            ...
                            @foreach($insurances as $insurance)
                                <form class="form-horizontal" role="form" method="POST" action="{{url('/updateHospitalInsuranceMapping/'.$hospital->id.'/'.$insurance->transaction_id)}}" enctype="multipart/form-data">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{url('/deleteHospitalInsuranceMapping/'.$insurance->transaction_id)}}" class="btn-primary btn">Delete Insurance Mapping</a></td>
                                        {{--<td><button class="btn-primary btn" type="submit">Update Mapped Insurance</button></td>--}}
                                    </tr>
                                </form>
                            @endforeach
                            </tbody>
                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <a href="{{url('/mapHospitalInsuranceAvailable/'.$hospital->id)}}" class="btn-primary btn">Map Available Insurance</a>
                        </div>
                    </div>
                </div>
            </div>
